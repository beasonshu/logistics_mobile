...
//							CommSet.inserBillInfo();
	...
	private void from() {
		((TextView) findViewById(R.id.textViewmain_name)).setText(getSharedPreferences("mybill", 0).getString("USER_NAME", ""));
		((TextView) findViewById(R.id.textViewmain_head)).setText(getSharedPreferences("mybill", 0).getString("lasthead", ""));
		((TextView) findViewById(R.id.textViewmain_body)).setText(getSharedPreferences("mybill", 0).getString("lastbody", ""));
	}
}