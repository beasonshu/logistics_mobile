...
import com.ia.logistics.scan.view.ViewfinderView;
import com.google.zxing.BarcodeFormat;
import com.google.zxing.Result;


public class CaptureActivity extends BaseComActivity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		capture_cancle = (Button) findViewById(R.id.capture_cancle);
		viewfinderView = (ViewfinderView) findViewById(R.id.viewfinder_view);
		hasSurface = false;
		inactivityTimer = new InactivityTimer(this);
		capture_cancle.setOnClickListener(new OnClickListener() {
